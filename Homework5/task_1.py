...
def letter_stat(our_str):
    """Выводит количество вхождений буквы в строку
        :param: our_str - строка
        :return: letters_dict - словарь, где в качестве ключей буквы строки, а значениями
        являются числа,соответствующие количеству вхождений данной буквы в строку"""
    our_list = list(our_str)
    letters_dict = {letter: our_list.count(letter) for letter in our_list}
    return letters_dict
